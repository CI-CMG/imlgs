    ...
    return (
        <header className={baseClass}>
           <a href="https://www.ncei.noaa.gov/" title="National Centers for Environmental Information, National Oceanic and Atmospheric Administration">
              <img className={`${baseClass}--nceiLogo`} src="/assets/map-banner.png" alt="National Centers for Environmental Information, National Oceanic and Atmospheric Administration"/>
            </a>
            ...
            <a href="https://www.nsf.gov/div/index.jsp?div=OCE" title="external link to the National Science Foundation Ocean Sciences Division" target="_top">
                <img className={`${baseClass}--nsfLogo`} src="/assets/NSFLogo.png" alt="US National Science Foundation Division of Ocean Sciences"/>
            </a>
