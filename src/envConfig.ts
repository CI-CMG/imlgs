...
// export const routerBasename = '/viewers/imlgs/'
// export const routerBasename = '/viewers/beta/imlgs/'
export const mapserviceUrl = 'https://gis.ngdc.noaa.gov/arcgis/rest/services/web_mercator/sample_index_dynamic/MapServer'
export const mapviewerUrl = 'https://maps.ngdc.noaa.gov/viewers/beta/imlgs/samples'
