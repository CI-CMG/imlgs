...
return t1 + t2;
}`)}let Xo=class extends J{constructor(e,r){super(e,"mat3",z.Draw,(o,i,a)=>o.setUniformMatrix3fv(e,r(i,a)))}},pe=class extends J{constructor(e,r){super(e,"mat3",z.Pass,(o,i,a)=>o.setUniformMatrix3fv(e,r(i,a)))}},Ve=class extends J{constructor(e,r){super(e,"mat4",z.Pass,(o,i,a)=>o.setUniformMatrix4fv(e,r(i,a)))}};function Ko(t,e){t.include(Sr);const r=t.vertex;r.include(qo,e),t.varyings.add("vPositionWorldCameraRelative","vec3"),t.varyings.add("vPosition_view","vec3"),r.uniforms.add(new Q("transformWorldFromViewTH",o=>o.transformWorldFromViewTH),new Q("transformWorldFromViewTL",o=>o.transformWorldFromViewTL),new pe("transformViewFromCameraRelativeRS",o=>o.transformViewFromCameraRelativeRS),new Ve("transformProjFromView",o=>o.transformProjFromView),new Xo("transformWorldFromModelRS",o=>o.transformWorldFromModelRS),new he("transformWorldFromModelTH",o=>o.transformWorldFromModelTH),new he("transformWorldFromModelTL",o=>o.transformWorldFromModelTL)),r.code.add(s`vec3 positionWorldCameraRelative() {
...
return proj * (view * vec4(pos, 1.0));
  ...
  `)}let li=class extends J{constructor(e,r){super(e,"int",z.Pass,(o,i,a)=>o.setUniform1i(e,r(i,a)))}};function ci(t,e){e.hasSymbolColors?(t.include(ws),t.attributes.add(h.SYMBOLCOLOR,"vec4"),t.varyings.add("colorMixMode","mediump float"),t.vertex.code.add(s`int symbolColorMixMode;
vec4 getSymbolColor() {
...
void forwardNormalizedVertexColor() {}`)}let te=class extends J{constructor(e,r){super(e,"vec4",z.Pass,(o,i,a)=>o.setUniform4fv(e,r(i,a)))}};function Os(t){t.vertex.code.add(s`float screenSizePerspectiveMinSize(float size, vec4 factor) {
...
}`)}function Es(t){t.uniforms.add(new te("screenSizePerspectiveAlignment",e=>Ms(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function Ms(t){return oe(Rs,t.parameters.divisor,t.parameters.offset,t.parameters.minPixelSize,t.paddingPixelsOverride)}const Rs=Vt();function ui(t,e){const r=t.vertex;e.hasVerticalOffset?(Ls(r),e.hasScreenSizePerspective&&(t.include(Os),Es(r),gt(t.vertex,e)),r.code.add(s`
...
vec4 vvLocalNormal(vec3 _normal) { return vec4(_normal, 1.0); }`),e.vvColor?(r.constants.add("vvColorNumber","int",Jt),r.uniforms.add(new Vs("vvColorValues",i=>i.vvColor.values,Jt),new zs("vvColorColors",i=>i.vvColor.colors,Jt)),r.code.add(s`
...
color.a = 1.0;
}`);break;case X.Mask:o.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case X.MaskBlend:t.fragment.code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}function hi(t,e){const{vertex:r,fragment:o}=t,i=e.hasModelTransformation;if(i){const n=Tt();r.uniforms.add(new Ve("model",l=>l.modelTransformation??Ke)),r.uniforms.add(new pe("normalTransform",l=>(Rt(n,l.modelTransformation??Ke),n)))}const a=e.hasColorTexture&&e.alphaDiscardMode!==X.Opaque;switch(e.output){case y.Depth:case y.Shadow:case y.ShadowHighlight:case y.ShadowExcludeHighlight:case y.ObjectAndLayerIdColor:pt(r,e),t.include(ft,e),t.include(qe,e),t.include(vt,e),t.include(Is,e),t.include(Be,e),t.include($s,e),Jo(t),t.varyings.add("depth","float"),a&&o.uniforms.add(new Z("tex",n=>n.texture)),r.code.add(s`
          void main(void) {
            vpos = calculateVPos();
...
}`),e.textureCoordinateType!==Y.None&&(t.include(zo,e),r.uniforms.add(e.pbrTextureBindType===z.Pass?new Z("normalTexture",o=>o.textureNormal):new mt("normalTexture",o=>o.textureNormal)),r.code.add(s`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
precision highp sampler2D;`,Yt=4;function Qs(){const t=new kt,e=t.fragment;t.include(mi);const r=(Yt+1)/2,o=1/(2*r*r);return e.include(Or),e.uniforms.add(new Z("depthMap",i=>i.depthTexture),new mt("tex",i=>i.colorTexture),new Gs("blurSize",i=>i.blurSize),new ee("projScale",(i,a)=>{const n=ea(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,i.projScale-(n-5e4)):i.projScale}),new Ce("nearFar",(i,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Zs=Object.freeze(Object.defineProperty({__proto__:null,build:Qs},Symbol.toStringTag,{value:"Module"}));let Js=class gi extends yr{initializeProgram(e){return new Cr(e.rctx,gi.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};Js.shader=new Wt(Zs,()=>xt(()=>import("./SSAOBlur.glsl-fd4249c8.js"),["assets/SSAOBlur.glsl-fd4249c8.js","assets/index-632af840.js","assets/index-9e16f38c.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-4d060d73.js","assets/vec32-aac4b6cd.js","assets/DefaultMaterial_COLOR_GAMMA-b9b1373d.js","assets/quat-625bfdbb.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-7b5af16f.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-06e908ac.js","assets/InterleavedLayout-06ad5730.js","assets/types-1305598a.js","assets/sphere-2983c6c0.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-f1e6dc8e.js","assets/Texture-475a6d11.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-b78fdc44.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-5d791997.js"]));function Ys(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>el(r))),t.fragment.uniforms.add(new Ce("zScale",(e,r)=>xi(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function el(t){const e=t.camera.projectionMatrix;return e[11]===0?oe(no,2/(t.camera.fullWidth*e[0]),2/(t.camera.fullHeight*e[5]),(1+e[12])/e[0],(1+e[13])/e[5]):oe(no,-2/(t.camera.fullWidth*e[0]),-2/(t.camera.fullHeight*e[5]),(1-e[8])/e[0],(1-e[9])/e[5])}const no=Vt();function xi(t){return t.camera.projectionMatrix[11]===0?Pt(so,0,1):Pt(so,1,0)}const so=_o(),lo=16;function tl(){const t=new kt,e=t.fragment;return t.include(mi),e.include(Or),t.include(Ys),e.uniforms.add(new ee("radius",(r,o)=>Ti(o.camera))),e.code.add(s`vec3 sphere[16];
void fillSphere() {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function Ti(t){return Math.max(10,20*t.computeScreenPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const co=_o(),rl=Object.freeze(Object.defineProperty({__proto__:null,build:tl,getRadius:Ti},Symbol.toStringTag,{value:"Module"}));let ol=class _i extends yr{initializeProgram(e){return new Cr(e.rctx,_i.shader.get().build(),Gt)}initializePipeline(){return xr({colorWrite:Tr})}};ol.shader=new Wt(rl,()=>xt(()=>import("./SSAO.glsl-5c0a7ab3.js"),["assets/SSAO.glsl-5c0a7ab3.js","assets/index-632af840.js","assets/index-9e16f38c.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-4d060d73.js","assets/vec32-aac4b6cd.js","assets/DefaultMaterial_COLOR_GAMMA-b9b1373d.js","assets/quat-625bfdbb.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-7b5af16f.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-06e908ac.js","assets/InterleavedLayout-06ad5730.js","assets/types-1305598a.js","assets/sphere-2983c6c0.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-f1e6dc8e.js","assets/Texture-475a6d11.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-b78fdc44.js","assets/VertexElementDescriptor-2925c6af.js","assets/VertexArrayObject-5d791997.js"]));const il=2;function Er(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(o,i)=>i.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/il),r.code.add(s`float evaluateAmbientOcclusionInverse() {
...
}`))}const uo=$(),Te=Vt();function Mr(t){t.uniforms.add(new Q("mainLightDirection",(e,r)=>r.lighting.mainLight.direction))}function jt(t){t.uniforms.add(new Q("mainLightIntensity",(e,r)=>r.lighting.mainLight.intensity))}function ho(t){Mr(t.fragment),jt(t.fragment),t.fragment.code.add(s`vec3 evaluateMainLighting(vec3 normal_global, float shadowing) {
